...
class Trainer(TrainerOperations):
    ...
    def train(self, x_train, y_train):
        ...
        print(' dataset:', self.config['path_x'], x_train.shape)
        print('         ', self.config['path_y'], y_train.shape)
        ...
        y_sample = self.config['y_sample']
        feed_dict_sample = {self.model.x:x_sample, self.model.z: z_sample,
                            self.model.y:y_sample, self.model.is_training:False}
    ...
    def gen(self, num=256, filepath=None, batch_size=None, path=None, is_plot=True, y_test=None):
        ...
        for bidx in range(num_batch):
            ...
            y_batch = y_test[bidx*batch_size:(bidx+1)*batch_size]
